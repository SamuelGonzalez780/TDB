...
from windBuy import Buy
from windSell import Sell
from windCustomers import Customers
...
class Index(CTkFrame):
    def __init__(self, root):
        ...
        self.frameHalf = CTkScrollableFrame(self.root, corner_radius=10, height=self.root.winfo_height(),
                                            fg_color='#F9FAFB')
        self.frameHalf.pack(fill=BOTH, expand=False, padx=10, pady=10)
        ...
        self.lblTitle = CTkLabel(self.frameTop, text='nombre sucursal: ...', font=('Verdana', 20, 'bold'),
                                 text_color='#f5f6fa', justify=RIGHT, )
    ...
    def _elementsIndex(self):
        ...
        self.btnPurchases = CTkButton(self.frameHalf, text='Comprar', font=('Verdana', 16), text_color='#1e272e',
                                      fg_color='#ffffff', border_color='#dcdde1', corner_radius=10,
                                      image=loadIcon('../Media/shpCartBlack.png', 40), command=lambda: self._frames(2))
        ...
        for button, hover_color, hover_icon, leave_icon, case in buttons:
            ...
            button.bind("<Leave>", lambda event, b=button, i=leave_icon: decrease(b, '#ffffff', i))
